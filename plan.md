...
Вероятно вам знакома эта картинка. Её автор, Тим Урбан, рассказал на конференции TED о прокрастинации. Он объяснил, что если «обезьянка» у руля, то с выполнением задач в срок помогает Панический монстр.
...
Представьте себе проект, в котором был жёсткий отбор фич и не было рефакторинга. Если условия сильно менялись, то приходилось надстраивать новые «костыли» поверх существующего. Так в мозге можно выделить три слоя вокруг ядра: рептильный, млекопитающий и новый. (здесь возможны ошибки в деталях)
...
- Минимизировать повторные мысли
      Я постоянно веду дневник, который состоит из отдельныx тезисов, мыслей, идей и хотелок
...
Привратить насилие в манипулияцию можно простым приёмом. Нужно из «я должен» постараться сделать «я хочу».

Тут помогают методы целеполагания, простейшим примером будет SMART

Например, «ты должен сделать это к полудню» можно превратить в «если сделать это к вечеру то будет так..., если к обеду так..., а если к полудню то будет так... и вот почему... и тебе за это будет вот это...»

...
Знакомо? Особенно меня бесит то, как я оттягиваю выполнение задач (как и этот доклад).

В такие моменты спасает только одно...

## Panic monster

Вероятно вам знакома эта картинка. Её автор, Тим Урбан, рассказал на конференции TED доклад о прокрастинации. В нём он объяснил, что если «обезьянка» у руля, то с выполнением задач в срок помогает Панический монстр.
...
Во-первых, кажется, что по описанию Маша студентка. И легко при наличии деталей проигнорировать общие вероятности. Думаю вы согласны с тем, что среди перечисленных вариантов кассиров в нашей стране больше всего, а аспирантов и вокалистов меньше? Это ошибка «Базового процента»
...
-   Животное — свободолюбивое существо. Оно мгновенно восстает против любых попыток ограничить или ущемить его в чем-либо.

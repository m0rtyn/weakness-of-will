...
Я работаю в  Semrush. Это онлайн-платформа для профессионалов в сфере digital-маркетинга

4000000+ пользователей

Офисы в четырёх странах

«Best Digital Tool» Interactive marketing awards 2019
...
Существует несколько моделей мышления, котором оно разделено на две автономные части.
...
Знакомо? Особенно меня бесит то, как я оттягиваю выполнение задач. В такие моменты спасает только одно...

## Panic monster

Вероятно вам знакома эта картинка. Её автор, Тим Урбан, рассказал на конференции TED отличный доклад о прокрастинации. В нём он объяснил, что когда «обезьянка» у руля, то с выполнением задач в срок помогает только Панический монстр.

Но является он перед самым дедлайном, сильно выматывает и в результате получается много ошибок.

Эту же метафору использует Максим Дорофеев в своей книге «Джедайские техники». Эта книга научила меня не полагаться на силу Панического монстра, а успешно взаимодействовать со своим «животным».

Чтобы наладить сотрудничество для начала нужно знатьсильные и слабые стороны «Животного» и «Человека».
...
-   Спокойный +
-   Сфокусированный +
-   Контролирует, планирует и терпит — сила воли (внутренний критик)  +/-
...
-   А кто считает, что Воля подобна бензобаку и осознанность человека зависит от того, как много топлива в нём осталось? Ок

-   А есть те, кто-то представляет Волю сложной волновой функцией от множества внутренних и внешних факторов?

<!-- ~~~ -->

Я задал эти вопросы в порядке того, как развивалось понимание волевого ресурса у меня. Себя отношу скорее к третьим, но уже хорошо будет понимать на втором уровне.

Батарейка как метафора к работе префронтальной коре головного мозга -- той части мозга, которая отличает людей от животных. Красная область на слайде это слой в ~2мм и этой коры у нас с вами крайне мало.
...
Представьте себе проект, в котором был жёсткий отбор фич и не было рефакторинга. Если условия сильно менялись, то приходилось надстраивать новые «костыли» поверх существующего. Так в мозге можно выделить три слоя вокруг ядра: рептильный, лимбический и новый. (здесь возможны ошибки в деталях)

Исходя из этой модели мозга я всегда являюсь животным и иногда человеком, который способен животное хитро направить.
...
Кефир и батон вместе стоят 110 рублей. Известно что кефир на 100 рублей дороже.
...
Во-первых, кажется, что по описанию Маша студентка. И легко при наличии специфических сведений проигнорировать общие данные о частоте. Думаю вы согласны с тем, что среди перечисленных вариантов кассиров в нашей стране больше всего, а аспирантов и вокалистов меньше? Это ошибка «Базового процента»

Во-вторых, кажется, что если Маша не только студентка, но и занимается йогой, то это повышает вероятность последнего варианта. Но нет, посмотрите на круги Эйлера: правый круг множество студенток, левый -- тех, кто занимается йогой. Между ними есть пересечение по площади меньшее исходных выборок. Это ошибка Конъюнкции.

## Когнитивные искажения

Я привёл в пример две ошибки, которые в общем называются когнитивными искажениями.

И таких ошибок более сотни. Забавно то, что некоторые из вас сейчас видя слайд испытывают когнитивные искажения связанные с большим количеством новой информации.
...
2.  Когда запоминаем и вспоминаем
    -   Ложная память это пример того, что наша память весьма изменчива. Проводились исследования, в которых люди додумывали ложную информацию и подгоняли под неё воспоминания.
...
Во-первых, нужно понять, что для избежания искажений нужна осознанность (воля), но она очень дорога и крайне дифицитна. Соответственно я учусь эффективно и своевременно восстанавливать волевой ресурс чтобы чаще быть осознанным. В осознанности частота важнее длительности. Мне удаётся сохрананять осознанность до 4 часов в день. И если я буду избыточно медитировать, то повышается риск когнитивных проблем (депрессия, суицидальные наклонности, диссоциация и т.д.).
...
-   Циклично отдыхать
    -   Я медитирую в тишине каждые два часа
-   Минимизировать повторные мысли
    -   Я постоянно веду дневник, который состоит из отдельных тезисов, мыслей, идей и хотелок
-   Разгружать рабочую память
    -   Я веду учёт дел в личной системе, через которую проходят поступающие задачи
...
-   Животное — чрезвы­чайно свободолюбивое существо. Оно мгновенно восстает против любых попыток ограничить или ущемить его в чем-либо.
...
-   Животное любит все новое, забавное, интересное, необычное и веселое. Она не терпит скуку, тоску и однообразие, да и вообще терпеть не умеет.

Привратить насилие в манипулияцию можно простым приёмом. Нужно из «я должен» постараться сделать «я хочу». Например, «ты должен сделать это к полудню» можно превратить в «если сделать это к вечеру то будет так..., если к обеду так..., а если к полудню то будет так... и вот почему... и тебе за это будет вот это...»
